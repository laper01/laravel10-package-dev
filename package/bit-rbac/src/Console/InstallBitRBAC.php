...
use Danova\BitRbac\Console\InstallsApiStack;


class InstallBitRBAC extends Command
{
     ...
     * @var string
     */
    protected $signature = 'bitrbac-api:install
     ...
     * @var string
     */
    protected $description = 'install bit rbac';
