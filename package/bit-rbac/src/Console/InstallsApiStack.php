...
trait InstallsApiStack
{
    ...
    protected function installApiStack()
    {
        ...
        // middleware
        copy(__DIR__ . '/../../stubs/api/app/Http/Middleware/RbacApi.php', base_path('app/Http/Middleware/RbacApi.php'));
        copy(__DIR__ . '/../../stubs/api/app/Http/Middleware/RbacWeb.php', base_path('app/Http/Middleware/RbacWeb.php'));
        // install middleware
        ...
        // copy directori Seedder
        $files->copyDirectory(__DIR__.'/../../stubs/api/database/seeders', base_path('database/seeders'));
        ...
        $this->components->info('rbac berhasil di installl.');
    }
